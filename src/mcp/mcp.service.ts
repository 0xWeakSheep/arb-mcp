...
export class McpService {
  ...
  getTools(): McpTool[] {
    return [
      // Aave Tools
      {
        name: "aave_stake",
        description:
          "Stake (supply) tokens to Aave V3 protocol on Arbitrum One network",
        inputSchema: {
          type: "object",
          properties: {
            asset: {
              ...
              enum: ["USDC", "USDCe", "USDT", "DAI", "GHO", "EURS", "WETH", "wstETH", "weETH", "ezETH", "rETH", "rsETH", "ARB", "WBTC", "tBTC", "AAVE", "LINK"],
            },
            amount: {
              type: "string",
        ...
        inputSchema: {
          ...
          properties: {
            asset: {
              ...
              enum: ["USDC", "USDCe", "USDT", "DAI", "GHO", "EURS"],
            },
            amount: {
              type: "string",
      ...
      {
        name: "swap_quote",
        description: "Get swap quote from Uniswap V3 on Arbitrum One",
        inputSchema: {
          type: "object",
          properties: {
            fromToken: {
      ...
      {
        name: "get_gas_price",
        description: "Get current gas price on Arbitrum One",
        inputSchema: {
          type: "object",
          properties: {},
        },
  ...
  private handleCompletion(request: McpRequest): McpResponse {
    ...
    const completions = {
      "stake ": ["USDC", "WETH", "DAI", "ARB"],
      "withdraw ": ["USDC", "WETH", "DAI", "ARB", "max"],
